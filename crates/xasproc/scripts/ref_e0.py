...
Loads the Cu foil mu(E) (crates/xasproc/tests/data/cu.xmu) and dumps:
  - find_energy_step(energy)
  - find_e0(energy, mu)
  - smooth(...) and polyfit(...) on fixed inputs (direct primitive parity)

Writes crates/xasproc/tests/data/ref_e0.txt.

Run from the repo root with the project venv:
    .venv/bin/python crates/xasproc/scripts/ref_e0.py
"""
import os
import numpy as np
