...
//!
//! The mask math lives in [`xasproc::clean`] (parity with larch's interactive
...
use xasproc::clean::{deglitch_point_mask, deglitch_range_mask, removed_count, select, trim_mask};
use xasproc::mathutils::smooth;

use crate::group::XasGroup;

pub use xasproc::clean::RangeSide;
pub use xasproc::mathutils::SmoothForm;
...
/// ([`xasproc::mathutils::smooth`]), then clear the derived stages so reduction
